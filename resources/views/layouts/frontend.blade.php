                            ...
                            <div class="menu-style-2 furniture-menu menu-hover">
                                <nav>
                                    <ul>
                                        ...
                                        <li>
                                            <a href="{{ route('shop.index') }}">Type</a>
                                        </li>
                                        <li><a href="#">Login</a>
                ...
                <div class="container-fluid">
                    <div class="widget-wrapper">
                        <div class="footer-widget mb-30">
                            <h3 class="footer-widget-title-5">About </h3>

                        <!-- <img height="60" style="transform:scale(1.5);object-fit: cover;" src="{{ asset('frontend/assets/img/logo/logo.png') }}" alt=""> -->
                            <div class="footer-about-2">
                                <p>Because we want us to be with you every step of the way.</p>
                            </div>
                        </div>
                        <div class="footer-widget mb-30">
                            ...
                            <div class="footer-info-wrapper-3">
                                <div class="footer-address-furniture">
                                    ...
                                    <div class="footer-info-content3">
                                        <p>20 Dong Da Street Hai Chau, Da Nang, Viet Nam<br>USA- 10800</p>
                                    </div>
                                </div>
                                <div class="footer-address-furniture">
                                    <div class="footer-info-icon3">
                                ...
                                <div class="footer-address-furniture">
                                    ...
                                    <div class="footer-info-content3">
                                        <p><a href="#">nguyenchien100203@gmail.com</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12 text-center">
                            <div class="copyright-furniture">
                                <p>© Copyright owned by Nguyen Huu Chien</p>
                            </div>
                        </div>
                    </div>
                </div>
